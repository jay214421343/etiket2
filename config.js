const config = {
  ...
  mongo: "mongodb://username:password@example.com:55258/enmap",

  // This implementation uses ngrok.io's wonderful tunneling service to provide a public URL.
  // This is for a paid, static ngrok.io subdomain, otherwise it won't work.
  // To enable, set enabled to true, enter a proper port, auth token from your ngrok admin, region, and subdomain.
  ngrokoptions: {
    enabled: false,
    addr: 8000,
  ...
  // Dashboard configuration. The URL must be publicly assessible. Leave /callback in the URL. 
  // This must coincide with a valid callback URL in your app's page in the Discord Developer tools.
  dashboard : {
